...
// import 'package:islami_c13_sun/ui/model/hadeth.dart';
...
//     await rootBundle.loadString("assets/files/ahadeth.txt");
//
//     List<String> ahadethAsStrings = hadethFileContent.split(RegExp(r"#\r?\n"));
//
//     ahadeth.clear(); // Clear the list before populating it
//     print(ahadethAsStrings.length);
//     for (int i = 0; i < ahadethAsStrings.length; i++) {
//       String hadethString = ahadethAsStrings[i];
//
//       List<String> hadethLines = hadethString
//           .split("\n")
//           .map((line) => line.trim())
//           .toList(); // Trim lines to avoid extra spaces
//       hadethLines.removeWhere((line) => line.isEmpty); // Remove empty lines
//
//       if (hadethLines.isNotEmpty) {
//         String title = hadethLines[0]; // The first line is the title
//         hadethLines.removeAt(0); // Remove the title from the list
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            SizedBox(height: 30), // Adjust this height to move the logo down
            Image.asset(AssetsManager.islamiLogo), // Logo
            SizedBox(height: 10), // Space between logo and carousel
            Expanded(
              child: ahadeth.isEmpty
